local layout = {
    --Single display, shows 8 macros when a trigger combination is pressed.
    SingleDisplay = {        
    ...
    --Double display, for 16 macros simultaneously visible in default view.    
    DoubleDisplay = {        
        --Amount is not fixed, you can adjust as desired.
        SkillchainFrames = T{
            'misc/crawl1.png',
...
if ((scaling.window.w == -1) or (scaling.window.h == -1) or (scaling.menu.w == -1) or (scaling.menu.h == -1)) then
    layout.SingleDisplay.DefaultX = 0;
    layout.SingleDisplay.DefaultY = 0;
    layout.DoubleDisplay.DefaultX = 0;
    layout.DoubleDisplay.DefaultY = 0;
else
    layout.SingleDisplay.DefaultX = (scaling.window.w - layout.SingleDisplay.PanelWidth) / 2;
    layout.SingleDisplay.DefaultY = scaling.window.h - (scaling.scale_height(136) + layout.SingleDisplay.PanelHeight);
    layout.DoubleDisplay.DefaultX = (scaling.window.w - layout.DoubleDisplay.PanelWidth) / 2;
    layout.DoubleDisplay.DefaultY = scaling.window.h - (scaling.scale_height(136) + layout.DoubleDisplay.PanelHeight);
end
