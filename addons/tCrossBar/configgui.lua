...
CheckBox('Recast', 'ShowRecast');
                ...
                if imgui.BeginTabItem('Behavior##tCrossbarConfigBehaviorTab') then
                    ...
                    CheckBox('During Main Menu', 'HideWhileMainMenu');
                    imgui.ShowHelp('Hides UI while main menu is open (Status, Equipment, Items, Magic, etc.).');
                    CheckBox('Inactive + Out of Combat', 'HideWhenInactive');
                    imgui.ShowHelp('Hides UI when no triggers are pressed and you are not engaged in combat.');
